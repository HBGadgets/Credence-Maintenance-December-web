...
export const getWarehouseApi = async ({ queryKey }) => {
  ...
  const { data } = await axios.get(`${import.meta.env.VITE_API_URL}/api/warehouse/get`, {
    params: {
      search: search || '',
      page,
      limit,
...
export const postWarehouseApi = async (create) => {
  try {
    const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/warehouse/add`, create, {
      headers: { Authorization: `Bearer ${TOKEN}` },
    })
...
export const getWarehouseProfileApi = async ({ queryKey }) => {
  ...
  const { data } = await axios.get(`${import.meta.env.VITE_API_URL}/api/warehouseproduct/get`, {
    params: {
      warehouseId: id,
      search: search || '',
      page,
...
export const getInventoryApi = async ({ queryKey }) => {
  ...
  const { data } = await axios.get(`${import.meta.env.VITE_API_URL}/api/warehouse/product`, {
    params: {
      search: search || '',
      page,
      limit,
...
export const getWarehouseListApi = async ({ search, page, limit }) => {
  ...
  const { data } = await axios.get(`${import.meta.env.VITE_API_URL}/api/warehouse/dropdown/list`, {
    params: {
      search: search || '',
      page,
      limit,
...
export const getGodownTPApi = async ({ queryKey }) => {
  const [_key, { search, page, limit, consignorId, consigneeId, companyId, workerId, status }] =
    queryKey
  ...
  const { data } = await axios.get(`${import.meta.env.VITE_API_URL}/api/godown-lorry-receipt/get`, {
    params,
    headers: { Authorization: `Bearer ${TOKEN}` },
  })
