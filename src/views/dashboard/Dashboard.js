          ...
          <CCol xs="12" sm="6" lg="3">
            <CCard className="shadow-sm border-0">
              ...
              <CCardBody>
                ...
                <p className="text-muted">All the Drivers who are currently on their work duties</p>
              </CCardBody>
            </CCard>
          </CCol>
          ...
          <CCol xs="12" sm="6" lg="3">
            <CCard className="shadow-sm border-0">
              ...
              <CCardBody>
                ...
                <p className="text-muted"> All Vehicles with their insurance expiring soon</p>
              </CCardBody>
            </CCard>
          </CCol>
