...
export const getLorryReciptApi = async () => {
    ...
    return data.map((lorryReciptList) => ({
        ...
        companyName: lorryReciptList?.companyId?.companyName || "Unknown",
        companyAddress: lorryReciptList?.companyId?.address || "Unknown",
        companyEmail: lorryReciptList?.companyId?.email || "Unknown",
        ...
        driverName: lorryReciptList.driverName || "N/A",
