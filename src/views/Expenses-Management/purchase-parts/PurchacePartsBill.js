...
const Purchase = () => {
  ...
  const handlePrint = (purchase) => {
    const printOption = window.prompt('Enter your choice: 1 for PDF, 2 for Excel')
  ...
  return (
    <div>
      <header style={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          ...
          <Button
            ...
            style={{ background: 'orange', color: 'white', width: '8.1rem' }}
          >
            Add New
          </Button>
        </div>
      ...
      <PurchaseForm
        ...
        handleAddModalClose={handleCloseAddModal}
      />
