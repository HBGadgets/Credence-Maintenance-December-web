...
const DocumentViewModal = ({
     ...
     useEffect(() => {
          if (imageData?.document?.image?.base64Data) {
               ...
               const contentType = imageData.document.image.contentType || 'image/jpeg'; // Fallback to JPEG if contentType is missing
                                                       ...
                                                       <>
                                                            {!imageError ? (
                                                                 ...
                                                                 <div className="text-center">
                                                                      ...
                                                                      <p className="text-muted">Failed to load image preview</p>
                                                                 </div>
                                                            )}
                                                       </>
                                                  ) : (
                                             ...
                                             {document.fileName && (
                                                  <div className="mb-3">
                                                       ...
                                                       <div className="fw-medium d-flex align-items-center">
                                                            {getFileIcon(document.fileName)}
                                                            <span className="ms-2">{document.fileName}</span>
                                                       </div>
                                                  </div>
                                             )}
