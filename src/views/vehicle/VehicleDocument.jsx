            ...
            {Insurance && (
              ...
              >
                ...
                <span style={{ color: 'black', marginTop: '5px' }}>
                  <strong>Insurance</strong> {Insurance || 'Not Available'}
                </span>
              </li>
            )}
            {fitnessCertificate && (
              ...
              >
                <FaRegFolderClosed size={40} />
                <span style={{ color: 'black', marginTop: '5px' }}>
                  <strong>Fitness Certificate</strong> {fitnessCertificate || 'Not Available'}
                </span>
              </li>
            )}
            {rc && (
              ...
              >
                <FaRegFolderClosed size={40} />
                <span style={{ color: 'black', marginTop: '5px' }}>
                  <strong>RC</strong> {rc || 'Not Available'}
                </span>
              </li>
            )}
            {puc && (
              ...
              >
                <FaRegFolderClosed size={40} />
                <span style={{ color: 'black', marginTop: '5px' }}>
                  <strong>PUC</strong> {puc || 'Not Available'}
                </span>
              </li>
            )}
          </ul>
